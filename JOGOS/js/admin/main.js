...
async function saveQuestion() {
    ...
    let _question = { question, options: {}, explanation };
    ...
    db.saveQuestion(_question, questionImage, answerImage, hideQuestionView, loadQuestionsList);
}
...
function saveBannerPub() {
    var file = $('input[name=bannerPubFile]')[0].files[0];
...
function downloadMobileVersion() {
